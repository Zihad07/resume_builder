...
@section('content')
    <div class="container">
        <div class="card card-body">
            <h2>Work Details</h2>
            <hr>
            <form action="{{ route('experience.store') }}" class="row g-3" method="post">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="employer" class="form-control @error('employer') is-invalid @enderror" id="employer">
                    @error('employer')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
